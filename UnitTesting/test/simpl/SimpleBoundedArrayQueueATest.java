...
public class SimpleBoundedArrayQueueATest
{
  ...
  @Test public void testEnqueueWithOneElement()
  {
    q.enqueue("Elephant");
  ...
  @Test public void testEnqueueWithSixElement()
  {
    for (int i = 0; i < 6; i++)
    {
    ...
    assertTrue(q.contains("Elephant1"));
