...
public class Thermometer implements Runnable
{
  ...
  public Thermometer(String id, double t, int d, ModelFactory modelFactory,
  ...
  @Override public void run()
  {
    while (true)
    {
      try
      {
        ...
        {
          case "t1":
            indoorTemperature1 = temperature(indoorTemperature1,
                modelFactory.getRadiator().getPower(), d, outdoorTemperaure, 6);
            modelFactory.getTemperatureModel()
                .addTemperature(id, indoorTemperature1);
            break;

          case "t2":
            indoorTemperature2 = temperature(indoorTemperature2,
                modelFactory.getRadiator().getPower(), d, outdoorTemperaure, 6);
            modelFactory.getTemperatureModel()
                .addTemperature(id, indoorTemperature2);
            break;
          case "t0":
            outdoorTemperaure = externalTemperature(outdoorTemperaure, -20, 20);
            modelFactory.getTemperatureModel()
                .addOutDoorTemp(id, outdoorTemperaure);
            break;
        }
